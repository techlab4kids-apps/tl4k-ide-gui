    ...
    <BooleanSetting
        ...
        help={
            <FormattedMessage
                ...
                defaultMessage="Allows pen projects to render at higher resolutions and disables some coordinate rounding in the editor. Not all projects benefit from this setting and it may impact performance. Set to be on default in TL4K IDE."
